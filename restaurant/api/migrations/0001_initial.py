# Generated by Django 4.2.9 on 2024-01-25 13:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pr', 'Processing'), ('ca', 'Cancel'), ('co', 'Complete')], default='pr', max_length=2)),
                ('address_delivery', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.address')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, to='api.restaurant'),
        ),
        migrations.AddField(
            model_name='myuser',
